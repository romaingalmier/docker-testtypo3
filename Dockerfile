...
RUN cd /var/www/html && \
    wget -O download.tar.gz https://get.typo3.org/11.5.22 && \
    echo "d78b2a1f8fa282957f4538a16f309f49176ee27c5cd63c68b47b2de518f7dcdc download.tar.gz" > download.tar.gz.sum && \
